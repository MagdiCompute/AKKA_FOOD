...
mixin _$DeliveryAddress {
 ...
 String get id; String get uid; String get label; String get streetAddress; String get city; double? get latitude; double? get longitude; bool get isDefault; DateTime get createdAt;
...
@override
int get hashCode => Object.hash(runtimeType,id,uid,label,streetAddress,city,latitude,longitude,isDefault,createdAt);

@override
String toString() {
  return 'DeliveryAddress(id: $id, uid: $uid, label: $label, streetAddress: $streetAddress, city: $city, latitude: $latitude, longitude: $longitude, isDefault: $isDefault, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String uid, String label, String streetAddress, String city, double? latitude, double? longitude, bool isDefault, DateTime createdAt
});
...
/// Create a copy of DeliveryAddress
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? uid = null,Object? label = null,Object? streetAddress = null,Object? city = null,Object? latitude = freezed,Object? longitude = freezed,Object? isDefault = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String uid,  String label,  String streetAddress,  String city,  double? latitude,  double? longitude,  bool isDefault,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DeliveryAddress() when $default != null:
return $default(_that.id,_that.uid,_that.label,_that.streetAddress,_that.city,_that.latitude,_that.longitude,_that.isDefault,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String uid,  String label,  String streetAddress,  String city,  double? latitude,  double? longitude,  bool isDefault,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _DeliveryAddress():
return $default(_that.id,_that.uid,_that.label,_that.streetAddress,_that.city,_that.latitude,_that.longitude,_that.isDefault,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String uid,  String label,  String streetAddress,  String city,  double? latitude,  double? longitude,  bool isDefault,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _DeliveryAddress() when $default != null:
return $default(_that.id,_that.uid,_that.label,_that.streetAddress,_that.city,_that.latitude,_that.longitude,_that.isDefault,_that.createdAt);case _:
  return null;
...
class _DeliveryAddress extends DeliveryAddress {
  const _DeliveryAddress({required this.id, required this.uid, required this.label, required this.streetAddress, required this.city, this.latitude, this.longitude, required this.isDefault, required this.createdAt}): super._();
...
/// Create a copy of DeliveryAddress
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? uid = null,Object? label = null,Object? streetAddress = null,Object? city = null,Object? latitude = freezed,Object? longitude = freezed,Object? isDefault = null,Object? createdAt = null,}) {
