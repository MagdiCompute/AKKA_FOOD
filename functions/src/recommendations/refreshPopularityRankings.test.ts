...
// Import AFTER mocks
import "./refreshPopularityRankings";

// ── Helpers ───────────────────────────────────────────────────────────────────

function makeMealDoc(id: string, name: string, popularityScore: number) {
  return {
    id,
...
describe("refreshPopularityRankings", () => {
  ...
  it("does nothing when no meals are found", async () => {
    ...
    expect(mockLoggerInfo).toHaveBeenCalledWith(
      "No meals found for popularity rankings",
